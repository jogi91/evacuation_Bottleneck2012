...
Since this project has very similar foundations as \cite{multilevel}, we were
able to use a lot of code from their repository.  Some of the structure needed
to be changed to implement our custom features, but for example the utility
functions for the Fast Sweeping algorithm and the linear interpolation which
