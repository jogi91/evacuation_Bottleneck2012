...
\newcommand{\source}[1]{\begin{textblock*}{4.5cm}(8.0cm,8.1cm)
...
\begin{frame}
	...
	\begin{columns}
		...
		\end{column}
	\end{columns}
	\source{\url{http://www.shipspotting.com}, Picture taken by Roy Batty}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		...
		\end{column}
	\end{columns}
	\source{\url{http://www.kreuzfahrtberater.de}}
\end{frame}
